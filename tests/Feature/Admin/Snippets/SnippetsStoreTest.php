...
class SnippetsStoreTest extends TestCase
{
    /** @test */
    public function snippet_can_be_stored()
    {
        $this->post(route('admin.snippets.store'), [
            'title' => 'Test title',
        ...
        $this->assertEquals('Test title', $snippet->title);
        $this->assertEquals('Test description', $snippet->description);
        $this->assertEquals('<!DOCTYPE HTML><html></html>', $snippet->contents);
    }
